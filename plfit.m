...
% Initialize Data Array
    ...
    % dat is initialized to store the K-S statistics for each candidate xmin.
...
% Compute K-S Statistic
    ...
    % The K-S statistic is the maximum absolute difference between cf and cx and is stored in dat.
...
% Select the Best xmin
    ...
    % D is the minimum K-S statistic value from dat.
...
% Apply Optional Parameters
    ...
    % Initialize the data array to store the K-S statistics and corresponding alpha values for each candidate xmin.
    ...
    % Loop through each candidate xmin.
        ...
        % The K-S statistic is computed by comparing the empirical cumulative distribution function (CDF) and the fitted CDF.
        % The K-S statistic and corresponding alpha are stored in dat.
    ...
    % Select the index for the minimum value of the K-S statistic (D).
